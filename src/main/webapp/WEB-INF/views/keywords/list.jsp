...
<html>
<head>
    <title>KeywordsList</title>
    <script src="/resources/jquery/jquery-3.6.1.min.js"></script>
    <script src="/resources/bootstrap/bootstrap.bundle.min.js"></script>
    <link rel="stylesheet" href="/resources/bootstrap/bootstrap.min.css">
</head>
<body>
<h5 class="text-center">${domain.name}에 대한 KeywordList (용어 사전)</h5>
        ...
        <div class="d-flex justify-content-center">
            <div class="col-1">
                <select name="search" class="form-control form-control-sm">
                    ...
                    <option value="1" ${pager.search == 1 ? 'selected' : ''}>용어번호</option>
                    <option value="2" ${pager.search == 2 ? 'selected' : ''}>용어명</option>
                </select>
            </div>
            <div class="col-5">
...
<div class="d-flex justify-content-center">
    <div>
        <a href="./add" class="btn btn-sm btn-danger" style="margin-right: 5px"> 추가 </a>
    </div>
    <div>
        <a href="/domain/list" class="btn btn-sm btn-secondary"> 뒤로 </a>
    </div>
</div>
</body>
</html>
